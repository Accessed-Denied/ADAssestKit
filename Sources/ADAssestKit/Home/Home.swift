...
public struct Home {
    public static func loadHomeIcon(size: CGSize, color: UIColor,lineWidth: CGFloat = 1,strokeColor: UIColor = .gray, fillColor: UIColor = .clear) -> CAShapeLayer {
        let document = CAShapeLayer()
        document.strokeColor = strokeColor.cgColor
        document.lineWidth = lineWidth
        document.fillColor = fillColor.cgColor
